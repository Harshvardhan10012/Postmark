...
/**
 * @fileOverview An AI agent that suggests relevant tags for a blog post based on its content.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a blog post tagging expert. Given the content of a blog post, you will suggest relevant tags for the post.
